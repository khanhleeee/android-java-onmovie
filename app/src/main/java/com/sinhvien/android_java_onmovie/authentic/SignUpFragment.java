...
public class SignUpFragment extends Fragment {
    ...
    TextInputEditText etEmailSignUp, etPasswordSignUp, etComfirmPassword;
    Button btnSignUp;
...
//        etPasswordSignUp = view.findViewById(R.id.etPasswordSignUp);
        ...
        tvSignInBack = view.findViewById(R.id.tvSignInBack);
...
//            bundle.putString("comfirmpassword", etPasswordSignUp.getText().toString());
            navController.navigate(R.id.action_signUpFragment_to_nickNameFragment, bundle);
